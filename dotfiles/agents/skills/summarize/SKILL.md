...
| Folder | Purpose |
|---|---|
| `800 Summaries/` | Where summary notes land |
| `200 Source Material/250 References/` | Concept / company / product / place notes |
| `700 People/` | Person notes (creators, guests, mentioned people) |
...
SUMMARIES_DIR  = "800 Summaries"
REFERENCES_DIR = "200 Source Material/250 References"
PEOPLE_DIR     = "700 People"
...
11. **Audio archival + click-to-play** — for downloaded audio/video, delete the file.
